...
export default function LessonEngine({ exercises, romanization = true, quiet = false, reducedMotion = false, onFinish }) {
  ...
  return (
    <div>
      ...
      {ex.kind === "typing" ? (
        ...
        <div>
          <PushToTalk key={ex.id} target={ex.target} onResult={onSpoken} />
