...
import { login, signup } from "../services/mockApi.js";

// mode = "signup" (default, /signup) or "login" (/login)
export default function Signup({ onAuth, mode = "signup" }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Sprint 2: mockApi simulates POST /api/auth/login and /api/auth/signup
    try {
      const data = isLogin
  ...
  return (
    ...
    >
      ...
      <div className="onboard-main">
        ...
        >
          {isLogin
            ? "Log in to check student progress, streaks, and request Kofi's help. Sprint 2 demo: any email and password work."
